...
public interface RegionRepository {
     ...
     * @param id_Region string alfanumerico correspondiente al id de la Region  a la cual se desea insertar datos.
     ...
     */
    public String update(Region Region, String id_Region);


    /**
     * Lista todos las Regions de la base de datos ascendente por nombre.
     * Si la conexion falla lanzará excepción.
     *
     * @return retorna una lista de Region que contiene las Regions o null si se lanza excepcion.
     ...
     * @return retorna una lista de Region que contiene la Region con el id solicitado o null si se lanza excepcion.
     * @throws Exception Si la conexion falla o si no encuentra el id.
     */
    public List<Region> show(String id_Region);
     ...
     * @throws Exception Si la conexion falla o si no encuentra el id.
     */
    public void delete(String id_Region);
}
